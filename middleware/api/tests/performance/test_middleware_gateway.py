...
def run_transaction(username="pytest_user", phone="08012345678", target="register", verbose=False):
...
def test_secure_gateway_transaction():
    """Sanity test to ensure gateway responds correctly."""
    resp, elapsed, decrypted = run_transaction(verbose=False)
